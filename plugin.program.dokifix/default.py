...
ADDON=xbmcaddon.Addon(id='plugin.program.dokifix')
...
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/Project-Galaxy/build/master/fix').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("DOKI Fix","Downloading ",'', 'Please Wait')
